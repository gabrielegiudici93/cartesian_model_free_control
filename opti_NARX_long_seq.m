...
numero_esperimento=8008;
step_n=50;%step di durata 0.1sec
max_iter=30;

target=[0.1110; 0.6919; 0.3090]%8000  
...
f = @(inp)evalu_reaching_one_point_473_OL(inp,ai,para);
...
OPTI = tonndata(inp_opti',true,false);
[Xc,Xic,Aic,Tc] = preparets(netc,OPTI,{},Y); 
OUTNN=netc(Xc,Xic,Aic)
output_NN_pos=cell2mat(OUTNN);
...
% inp_optimal=inp
% inp_optimal(3,:)=inp_optimal(3,:)*100
